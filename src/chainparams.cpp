...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("seed1",  "seed1.lunariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.lunariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.lunariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed4",  "seed4.lunariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed5",  "seed5.lunariumcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed6",  "seed6.lunariumcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed7",  "seed7.lunariumcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed8",  "explorerxln.com"));
