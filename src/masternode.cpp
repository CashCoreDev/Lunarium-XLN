...
{
    if (nHeight >   865600) return 1000000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >  6928901) return        1 * COIN;
    if (nHeight >  4826501) return        2 * COIN;
    if (nHeight >  2724101) return        5 * COIN;
    if (nHeight >   621701) return       10 * COIN;
...
CAmount CMasternode::GetMasternodePayment(int nHeight)
{
    ...
    if (nHeight >    621701) return GetBlockValue(nHeight) * 95 / 100;
